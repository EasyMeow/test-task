...
@Component
public class SongsPage2 {
    private final static Logger log = LoggerFactory.getLogger(SongsPage2.class);
    private List<Song> songs = new ArrayList<>();
    private Studio studio;

    @Autowired
    public SongsPage2(List<Studio> studio) {
        this.studio = studio.get(0);
